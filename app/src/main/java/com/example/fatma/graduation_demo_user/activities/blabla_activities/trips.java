    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        data_recyclerView.addOnItemTouchListener(new RecyclerTouchListener(this, data_recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, final int position) {
                ...
                Intent confirm_trip=new Intent(trips.this, confirm_trip.class);
        ...
        search_for_ride(from,to,time);
    }
    private void search_for_ride(String leaving_from, final String Going_to, final long Date)
    {
