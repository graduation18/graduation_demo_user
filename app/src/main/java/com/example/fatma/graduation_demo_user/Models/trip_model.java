...
public class trip_model {
    ...
    public String Leave_from_city,going_to_city,Leave_from_state,going_to_state;
    public long time;
    ...
    public trip_model( String driver_id,double Leave_from_latt,double Leave_from_longt,double going_to_latt,double going_to_longt,
                       String Leave_from_city,String going_to_city, String Leave_from_state,String going_to_state,long time
                      ,int seats_number,int cost){
